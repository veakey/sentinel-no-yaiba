...
import { LayoutDashboard, Shield, Settings, LogOut, Ticket, FileText, BarChart3, Server } from 'lucide-react'
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { path: '/detection-summary', icon: BarChart3, label: t('navigation.detectionSummary') },
    { path: '/endpoint-summary', icon: Server, label: t('navigation.endpointSummary') },
    { path: '/tickets', icon: Ticket, label: t('navigation.tickets') },
    { path: '/reports', icon: FileText, label: t('navigation.reports') },
  ]
